...
<div class="col">
    <div class="card border-info">
        ...
        <form action="{{$this->route("semestreacademico/store")}}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-7 col-sm-6 col-12">
                        ...
                        <input type="date" name="fecha_inicio_inscripcion" id="fecha_inicio_inscripcion"
                            class="form-control" value="{{$this->DateActual("Y-m-d")}}">
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-5 col-sm-6 col-12">
                        ...
                        <input type="date" name="fecha_cierre_inscripcion" id="fecha_cierre_inscripcion"
                            class="form-control" value="{{$this-> AddRestDate("Y-m-d","+ 15 day")}}">
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-7 col-sm-6 col-12">
                        ...
                        <input type="date" name="fecha_inicio_llenadonotas" id="fecha_inicio_llenadonotas"
                            class="form-control" value="{{$this-> AddRestDate("Y-m-d","+ 30 day")}}">
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6  col-12">
                        ...
                        <input type="date" name="fecha_cierre_llenadonotas" id="fecha_cierre_llenadonotas"
                            class="form-control" value="{{$this-> AddRestDate("Y-m-d","+ 37 day")}}">
                    </div>
                </div>
            </div>

            <div class="card-footer">
                <button class="btn btn-outline-primary"><b>Registrar <i class="fas fa-save"></i></b></button>
            </div>
        </form>
    </div>
</div>
